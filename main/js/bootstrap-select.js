!function($) {
    var select_pick = function(element, options, e) {
        if (e ) {
            e.stopPropagation();
            e.preventDefault();
        }
        ...
        this.options = $.extend({}, $.fn.select_pick.defaults, this.$element.data(), typeof options == 'object' && options);
        ...
        this.val = select_pick.prototype.val;
        this.render = select_pick.prototype.render;
        this.init();
    };

    select_pick.prototype = {

        constructor: select_pick,
